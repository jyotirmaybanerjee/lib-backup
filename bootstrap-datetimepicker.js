...
// ReSharper disable once InconsistentNaming
    DateTimePicker = function (element, options) {
        ...
        attachDatePickerEvents = function () {
            ...
            picker.widget.on('click', '.gmt-switch *', $.proxy(getGmtNow, this)); // this handles time picker clicks
                ...
                return (
                    '<div class="bootstrap-datetimepicker-widget dropdown-menu" style="z-index:9999 !important;">' +
                        '<ul class="list-unstyled">' +
							...
							'<li class="gmt-switch"><table class="table-condensed"><tbody><tr><td colspan="7" class="now-gmt"><a class="btn" style="width:100%">Now(GMT)</a></td></tr></tbody></table></li>' +
